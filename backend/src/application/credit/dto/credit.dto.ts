import { IsNumber, IsString, IsNotEmpty, IsOptional, IsBoolean, IsDate, IsEnum } from 'class-validator';
...
readonly term?: number;
 ...
 @Type(() => Number)
readonly income?: number;
 @IsEnum(['bank', 'cooperative'], { message: 'El tipo debe ser bank o cooperative' })
 @IsOptional()
...
export class UpdateCreditDto {
 ...
 @IsOptional()
readonly institutionId?: string;
 @IsEnum(['PENDING', 'INSTITUTION_SELECTED', 'DOCUMENTS_SUBMITTED', 'UNDER_REVIEW', 'APPROVED', 'REJECTED'])
 @IsOptional()
